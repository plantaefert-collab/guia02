...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F5EE] text-[#173D32] selection:bg-[#D946EF]/20 selection:text-[#173D32]">
      {/* Nav */}
      <header className="sticky top-0 z-30 border-b border-[#173D32]/10 bg-[#F8F5EE]/90 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 md:h-20 md:px-10">
          ...
          <nav className="flex items-center gap-2 text-[11px] uppercase tracking-[0.18em] font-semibold sm:gap-6">
            ...
            <Link to={isLoggedIn ? "/aprender" : "/auth"} className="hidden text-[#173D32]/70 hover:text-[#D946EF] transition sm:inline">
              Aprender
            </Link>
            ...
            {isLoggedIn ? (
              <>
                <Link
                  to="/minha-orquidea"
                  className="hidden items-center gap-1.5 text-[#173D32]/70 hover:text-[#D946EF] transition sm:inline-flex"
                >
                ...
                <Link
                  to="/inicio"
                  className="inline-flex items-center gap-1.5 bg-[#173D32] px-3.5 py-2.5 text-[10px] font-bold uppercase tracking-widest text-[#F8F5EE] transition-colors duration-300 hover:bg-[#D946EF] sm:px-4"
                >
                  Continuar
              ...
              <>
                <Link
                  to="/auth"
                  className="inline-flex items-center gap-1.5 text-[#173D32]/80 hover:text-[#D946EF] transition"
                >
      ...
      <section className="relative flex flex-col overflow-hidden lg:flex-row lg:items-stretch lg:min-h-[calc(100vh-4rem)]">
        <div className="absolute top-0 right-0 hidden p-8 z-20 lg:block">
          <span className="text-[10px] tracking-[0.3em] font-semibold text-[#173D32]/60 uppercase">
            Heritage &amp; Growth
          </span>
        </div>
        ...
        <div className="z-10 flex w-full items-center p-8 md:p-16 lg:w-1/2 lg:p-24">
          <div className="max-w-2xl">
            <div className="mb-8 h-px w-20 bg-[#D946EF]" />
            ...
            <p className="mb-12 max-w-lg text-lg leading-relaxed text-[#173D32]/80 md:text-xl">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                to="/auth"
                className="bg-[#173D32] px-10 py-5 text-[10px] font-bold uppercase tracking-widest text-[#F8F5EE] transition-all duration-500 hover:bg-[#D946EF]"
              >
                Começar meu plano
              </Link>
              <Link
                to="/auth"
                className="border border-[#173D32]/20 px-10 py-5 text-[10px] font-bold uppercase tracking-widest text-[#173D32] transition-all duration-500 hover:bg-[#173D32] hover:text-[#F8F5EE]"
              >
                Ver o método
              </Link>
            </div>
            <p className="mt-6 text-[11px] uppercase tracking-[0.25em] text-[#173D32]/50">
              Acesso grátis
            </p>
          </div>
        </div>

        <div className="relative w-full bg-[#173D32]/5 lg:min-h-0 lg:w-1/2">
          <div className="p-6 md:p-12 md:pb-28 lg:p-20 lg:pb-32">
            <div className="relative w-full md:h-full">
              <div className="w-full overflow-hidden border border-[#173D32]/10 shadow-2xl">
                <img
                  src={welcomeOrchid}
      ...
      {/* Benefícios */}
      <section className="border-t border-[#173D32]/5 bg-[#F8F5EE] px-8 py-24 md:px-24 md:py-32">
          ...
          {BENEFITS.map((b) => (
            <div key={b.title} className="group flex flex-col">
              <div className="mb-6 flex items-baseline gap-4">
                <span className="font-serif text-3xl italic text-[#D946EF]">{b.n}</span>
                <h3 className="border-b border-transparent font-serif text-2xl font-normal transition-all group-hover:border-[#173D32]/10">
                  {b.title}
                </h3>
              </div>
              <p className="text-lg leading-relaxed text-[#173D32]/70">{b.body}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* Método de 2 Passos */}
      <section className="relative overflow-hidden bg-[#173D32] py-24 text-[#F8F5EE] md:py-32">
        <div className="mb-16 flex flex-col justify-between gap-12 px-8 md:px-24 lg:mb-24 lg:flex-row lg:items-end">
          <div className="max-w-3xl">
            <span className="mb-6 block text-[10px] font-bold uppercase tracking-[0.4em] text-[#D946EF]">
              Metodologia Proprietária
            </span>
            <h2 className="font-serif text-5xl font-normal leading-none md:text-7xl lg:text-8xl">
              O Método de <br />
              <span className="italic text-[#D946EF]">2 Passos</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 border-t border-[#F8F5EE]/10 md:grid-cols-2">
          <div className="group border-b border-[#F8F5EE]/10 transition-colors duration-500 hover:bg-[#F8F5EE]/5 md:border-b-0 md:border-r">
            <div className="relative p-12 lg:p-20">
              <div className="mb-10 flex h-16 w-16 items-center justify-center rounded-full border border-[#F8F5EE]/20 transition-all duration-500 group-hover:border-[#D946EF]">
              ...
              <Link
                to="/auth"
                className="flex items-center gap-4 text-[10px] font-bold uppercase tracking-widest text-[#D946EF]"
              >
      ...
      <section className="relative flex items-center justify-center overflow-hidden px-8 py-32 text-center md:py-40">
        ...
        <div className="relative z-10 max-w-4xl">
          ...
          <div className="flex flex-col items-center justify-center gap-6 md:flex-row md:gap-8">
            <Link
              to="/auth"
              className="w-full bg-[#D946EF] px-14 py-6 text-[10px] font-bold uppercase tracking-[0.2em] text-[#F8F5EE] shadow-xl transition-all hover:scale-105 md:w-auto"
            >
              Começar meu plano
            </Link>
            <Link
              to="/auth"
              className="w-full bg-[#173D32] px-14 py-6 text-[10px] font-bold uppercase tracking-[0.2em] text-[#F8F5EE] transition-all hover:bg-[#173D32]/90 md:w-auto"
            >
              Ver o método
            </Link>
          </div>
          <p className="mt-12 text-[10px] uppercase tracking-[0.3em] text-[#173D32]/40">
            Diagnóstico em menos de 2 minutos
          </p>
        </div>
      </section>

      <footer className="border-t border-[#173D32]/10 py-10 text-center">
        <div className="text-[10px] uppercase tracking-[0.3em] text-[#173D32]/50">
